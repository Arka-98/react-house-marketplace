...
function CreateListing() {
    ...
    return (
        <div className="container">
            <div className="text-5xl mb-4">Create a Listing</div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <label>Name</label>
                <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Enter a name" className="w-96 px-3 py-2 rounded-xl required:border-red-500" />
                {errors.name && <span className="flex items-center text-red-500"><MdInfo className="mr-2" />Please enter a name</span>}
                <label>Location</label>
                <textarea type="text" name="location" value={formData.location} onChange={handleChange} placeholder="Enter location" className="w-96 px-3 py-2 rounded-xl" />
